...
# When you call super with no arguments, Ruby sends a message to the parent of the current object, asking it to 
# invoke a method with the same name as where you called super from, 
